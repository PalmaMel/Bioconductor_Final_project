...
### No_filter script: Only delete those genes with an expression below the first quantile
...
### Below Mean script: Filter those samples below the Mean and then delete those genes with an expression below 0.1
